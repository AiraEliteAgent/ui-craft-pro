...
These prompts are useful when working with `ui-craft-pro` inside OpenClaw.

## Design direction
- Build a premium landing page for a fintech treasury product.
- Design a calmer interface for a private journaling app.
- Make this dashboard feel less generic and more operator-grade.
